...
export default function Stats() {
  ...
  if (adLoading) {
    return (
      <div className="fixed bottom-4 right-4 max-w-xs bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100">
        <div>Loading</div>
      </div>
    )
  }
